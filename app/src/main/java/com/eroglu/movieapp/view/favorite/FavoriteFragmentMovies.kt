...
import com.eroglu.movieapp.databinding.FragmentFavoriteMoviesBinding
...
@AndroidEntryPoint
class FavoriteFragmentMovies : Fragment() {
...
//            viewModel.adapterMovie.postValue(viewModel.favoriteMovieAdapter)
//        }
